...
Bot.sendKeyboard("🔙 Kembali","Voucher Indodax berhasil dicairkan!\n\n<=> • Nominal voucher: Rp `"+rupiah+"`\n<=> • Fee layanan: Rp `"+biaya_pro+"`\n<=> • Nominal transfer: Rp `"+total_rp+"`\n\nSilahkan masukan nomer DANA anda 🔻",{on_result:"/otw",disable_web_page_preview:true})
